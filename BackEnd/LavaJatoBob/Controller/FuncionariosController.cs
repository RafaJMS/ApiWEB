...
using LavaJatoBob.Models;

namespace LavaJatoBob.Controller
{
    ...
    public class FuncionariosController : ControllerBase
    {
        ...
        public FuncionariosController(LavaJatoBobContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Funcionario>> PostFuncionario(Funcionario funcionario)
        {
          if (_context.Funcionarios == null)
          {
              return Problem("Entity set 'LavaJatoBobContext.Funcionarios'  is null.");
          }
